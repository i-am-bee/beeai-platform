                    ...
                    capabilities=a2a.types.AgentCapabilities(
                        ...
                        extensions=[
                            a2a.types.AgentExtension(
                                uri=beeai_sdk.a2a.extensions.services.llm.LlmServiceExtension.URI,
                                params=beeai_sdk.a2a.extensions.services.llm.LlmServiceExtension.Params(
                                    model_requests={
                                        "default": beeai_sdk.a2a.extensions.services.llm.LlmServiceExtension.Params.ModelRequest(
                                            description="Chat model for conversational tasks",
                                            features=beeai_sdk.a2a.extensions.services.llm.LlmServiceExtension.ModelFeatures(
                                                streaming=True,
                                                tool_calling=True,
                                                tool_choice_support=("required", "none", "single", "auto"),
                                            ),
                                            suggested=("granite3.3:8b", "openai/gpt-4o"),
                                        )
                                    },
