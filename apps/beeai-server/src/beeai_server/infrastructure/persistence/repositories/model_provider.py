...
from beeai_server.domain.models.model_provider import ModelCapability, ModelProvider, ModelProviderType
...
model_providers_table = Table(
    ...
    Column("type", Enum(ModelProviderType), nullable=False),
...
class SqlAlchemyModelProviderRepository(IModelProviderRepository):
    ...
    async def create(self, *, model_provider: ModelProvider) -> None:
        ...
        try:
            ...
            raise DuplicateEntityError(entity="model_provider", id=model_provider.base_url) from ex
