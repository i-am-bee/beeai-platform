...
An **agent** is a lightweight container that communicates using the [Agent2Agent (A2A) Protocol](https://a2a-protocol.org/). Agents may also define **tools** to extend their capabilities.
...
- Routes communication between agents and clients via the A2A interface
...
You can also integrate BeeAI into your Python applications using the BeeAI SDK. This makes it easy to coordinate multiple agents programmatically within your own workflows.
